...
int main() {
    ...
    std::cout << "Push 100 million integers using linkedStack:  " << time_used.count() << " ms" << std::endl;
    ...
    t2 = std::chrono::high_resolution_clock::now();
    time_used = std::chrono::duration_cast<std::chrono::duration<double>>(t2 - t1)*1000;
    std::cout << "Pop 100 million integers using linkedStack:  " << time_used.count() << " ms" << std::endl;
